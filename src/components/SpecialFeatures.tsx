...
export const SpecialFeatures: React.FC = () => {
  ...
  return (
    <motion.section 
      className="flex w-full max-w-[1200px] flex-col items-stretch mt-[134px] px-4 max-md:mt-10 max-md:px-2"
      initial="hidden"
      whileInView="visible"
    ...
    >
      ...
      <motion.div 
        className="flex w-full items-center gap-6 flex-wrap justify-center mt-20 max-md:mt-10 max-md:flex-col max-md:gap-4"
        variants={containerVariants}
      >
