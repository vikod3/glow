...
const PricingPlan: React.FC<PricingPlanProps> = ({ title, subtitle, price, features, isPopular = false }) => {
  return (
    <div className="flex-1 p-4 pt-9 pb-9 bg-[rgba(115.81,115.81,115.81,0.07)] shadow-[2px_4px_16px_rgba(248,248,248,0.06)_inset] overflow-hidden rounded-[32px] border-[1.5px] border-[rgba(255,255,255,0.15)] backdrop-blur-[50px] flex flex-col justify-center items-center gap-6">
      <div className="w-[276px] pr-12 flex flex-col justify-start items-start gap-10">
        <div className={`${isPopular ? 'relative' : ''} flex flex-col justify-start items-start gap-5`}>
          ...
          {isPopular && (
            <div className="absolute left-[121px] top-[3px] px-3 py-1 bg-white rounded-full flex justify-center items-center gap-2">
