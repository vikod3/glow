    ...
    <section className="w-full max-w-[1200px] mt-[134px] px-4 max-md:mt-10 max-md:px-2">
      <div className="flex flex-col items-stretch max-md:max-w-full">
        ...
        <div className="w-full mt-20 max-md:mt-10">
          <div className="flex w-full items-center gap-6 flex-wrap max-md:flex-col max-md:gap-4">
            <FeatureCard
      ...
      <div className="relative w-full mt-20 max-md:mt-10">
        <div className="relative min-h-[400px] w-full overflow-hidden rounded-[32px] max-md:min-h-[200px] max-md:rounded-[20px]">
          ...
          <div className="relative flex items-end justify-start h-full p-8 max-md:p-4">
            <div className="bg-blend-luminosity backdrop-blur-[9.333333969116211px] bg-[rgba(18,18,18,0.50)] flex w-[110px] max-w-full flex-col items-stretch justify-center p-1 rounded-[23.333px] max-md:w-[80px]">
